...
var TMDB_API_KEY = '8c5989af9b0badc281e95b1890834bc';
...
function fetchTmdbInfo(tmdbId, mediaType) {
  ...
  if (cleanId.startsWith("tt")) {
    var findUrl = 'https://api.themoviedb.org/3/find/' + cleanId +
    ...
    return fetch(findUrl)
      ...
      .then(function(data) {
        ...
        if (mediaType === "movie") {
          ...
          item = (data.tv_results && data.tv_results[0]) ||
...
function findDiziBalItem(tmdbInfo) {
  ...
  function trySearch(index) {
    ...
    return performSearch(query, tmdbInfo.isTv)
          ...
          if (subMatch) {
            ...
            for (var i = 0; i < rawSubs.length; i++) {
              ...
              if (parts) {
                ...
                var isTr =
                  label.toLowerCase().includes("türk") ||
                  label.toLowerCase().startsWith("tr");
            ...
            streamEmbedUrlPromise = fetch(
              ...
              .then(function(detailJson) {
                return detailJson.data &&
                       detailJson.data.streamUrl;
              });
          }

          return streamEmbedUrlPromise
            .then(function(streamEmbedUrl) {

              if (!streamEmbedUrl) {
                return [];
              }

              return resolveEmbedStream(
                streamEmbedUrl,
                movieName
              )
